  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="luxury-card">
        <CardHeader>
          <CardTitle className="font-display-premium">Couple sign-in</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-2 font-dashboard">
          <Button asChild>
            <Link to="/admin">{t('admin.enter')}</Link>
          </Button>
          <Button asChild variant="outline">
            <Link to="/admin">Wedding admin</Link>
          </Button>
        </CardContent>
      </Card>
