  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto text-center">
        ...
        <p className={`text-muted-foreground text-xs uppercase mb-4 ${lang === 'km' ? 'font-khmer tracking-normal' : 'tracking-[0.2em]'}`}>{t('details.countdown')}</p>
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <div className={`text-[10px] sm:text-xs text-muted-foreground uppercase font-semibold mt-2.5 ${lang === 'km' ? 'font-khmer tracking-normal' : 'tracking-widest'}`}>
                  {label}
                </div>
              </motion.div>
            );
